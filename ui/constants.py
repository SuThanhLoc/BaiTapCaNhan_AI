...
COLOR_BUTTON_BELIEF = pg.Color("#FD7E14")
COLOR_BUTTON_BELIEF_HOVER = pg.Color("#FF9A3C")
COLOR_BUTTON_BELIEF_SELECTED = pg.Color("#E8590C")
...
ALGO_BUTTON_WIDTH = 130 # Increased width for longer names
ALGO_BUTTON_HEIGHT = 35
BUTTON_GAP_Y = 8 # Reduced gap
...
ALGORITHMS_TO_DISPLAY = [
    ...
    "Conformant BFS", "Backtracking", "AC-3 Solver",
    "AND-OR Search", "Q-Learning", "TD (SARSA)"
]
...
FRAME_CENTER_BOTTOM = POS_PATH_LARGE_Y + GRID_SIZE_LARGE + FRAME_PADDING # Default
# Adjust if nav buttons are inside or outside this frame
FRAME_CENTER_BOTTOM_WITH_NAV = NAV_BUTTON_Y + NAV_BUTTON_HEIGHT + FRAME_PADDING 
FRAME_CENTER_HEIGHT = FRAME_CENTER_BOTTOM_WITH_NAV - FRAME_CENTER_TOP # Adjusted for nav
